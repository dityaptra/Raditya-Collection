    ...
    <section id="location" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/3 p-8 md:p-12 bg-white flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="space-y-6 relative z-10">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-sunshine/10 flex items-center justify-center shrink-0 text-sunshine">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm mt-1">Telp 1: +62 859 4618 2092</p>
                  <p className="text-gray-600 text-sm mt-1">Telp 2: +62 819 9556 2665</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="w-full lg:w-2/3 h-80 lg:h-auto min-h-100">
            <iframe
