      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">
            Layanan <span className="text-sunshine">Profesional</span>
          </h2>
          <div className="w-24 h-1.5 bg-sunshine mx-auto mt-6 rounded-full"></div>
          <p className="mt-6 text-gray-600 max-w-2xl mx-auto text-lg">
            Apapun kebutuhan busana Anda, kami siap mengerjakannya dengan detail yang sempurna.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((item, index) => (
            ...
            >
              {/* Dekorasi: Nomor Besar di Background */}
